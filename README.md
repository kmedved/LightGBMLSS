...
## `News`
:boom: [2025-12-11] Release of v0.6.1 LightGBMLSS to [PyPI](https://pypi.org/project/lightgbmlss/). See the [release notes](https://github.com/StatMixedML/LightGBMLSS/releases) for an overview. <br/>
